...
part of 'conversations_client.dart';
...
class _ConversationsClient implements ConversationsClient {
  _ConversationsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<StartConversation> conversationsControllerStartConversation({
    ...
    final _options = _setStreamType<StartConversation>(
    ...
    late StartConversation _value;
    try {
      _value = StartConversation.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<List<Conversation>> conversationsControllerFindAll() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<EndConversation> conversationsControllerEndConversation({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EndConversation>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late EndConversation _value;
    try {
      _value = EndConversation.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
